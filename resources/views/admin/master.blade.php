...
<head>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}">
                ...
                <div class="sidebar-brand-text mx-3">Admin Collaundry</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <ul class="nav-item dropdown no-arrow">
                            ...
                            @guest
                                @if (Route::has('login'))
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('login') }}">{{ __('Sign In / Sign Up') }}</a>
                                    </li>
                                @endif

                            @else
                                <li class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Collaundry Kelompok 6</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Page level plugins -->
    <script src="{{asset('style2/vendor/chart.js/Chart.min.js')}}"></script>

    <!-- Page level custom scripts -->
    <script src="{{asset('style2/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('style2/js/demo/chart-pie-demo.js')}}"></script>
